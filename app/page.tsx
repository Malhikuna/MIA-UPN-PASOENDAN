      ...
      >
        ...
        <div className="flex flex-col justify-center md:min-h-[80vh] px-25 ">
          ...
          <p className="md:w-[686px]">
            ...
            consectetur sunt veniam ipsa voluptates maiores fugit nam possimus.
            Sequi ea ut delectus a cupiditate autem fuga deserunt, saepe quidem
            inventore!
          </p>
          <Input
      ...
      <div className="md:py-10 px-25 ">
        <div className="">
          ...
          <p>
            ...
            natus molestias harum repellat. Commodi modi ipsa aperiam nam id
            quidem!
          </p>
        </div>
        {/* Filter Buttons */}

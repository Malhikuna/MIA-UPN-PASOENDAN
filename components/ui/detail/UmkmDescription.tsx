...
const UmkmDescription: React.FC<UmkmDescriptionProps> = ({title, description, handleBackToProfile}) => {
  return (
    <div
      className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white/70 w-2/3 h-auto rounded-2xl py-10 px-20">
      <button
      ...
      <h1 className="text-4xl text-primary-content-dark font-bold mb-10">{title}</h1>

      <div className="flex justify-between">
        <div className="flex flex-col gap-5">
          <h1 className="text-primary-content-dark font-semibold text-4xl">Deskripsi</h1>
          <p>{description}</p>
        </div>
        <div className="flex flex-col gap-5">
          <h1 className="text-primary-content-dark font-semibold text-4xl">Jam Operasional</h1>
